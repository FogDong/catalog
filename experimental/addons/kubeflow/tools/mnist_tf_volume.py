...
""")
    ...
    tfjobjson = tfjobjson_template.substitute({ 'imagetraining': str(train_image),'modelpvc': modelvolop.outputs["name"]})
...
""")
    seldon_serving_json = seldon_serving_json_template.substitute({ 'imageserving': str(serve_image),'modelpvc': modelvolop.outputs["name"]})
